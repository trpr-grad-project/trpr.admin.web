  ...
  return (
    <div className="space-y-4 pt-8 md:pt-0 md:pl-8 md:border-l border-outline-variant/30">
      ...
      <div className="space-y-3">
        ...
        <textarea
          className="outline-0 w-full bg-white rounded-lg border border-error focus:ring-1 focus:ring-error focus:border-error p-4 placeholder-secondary/70 text-sm"
          placeholder="State clearly why the request was denied..."
          rows={3}></textarea>
      </div>
      <button className="w-full py-4 bg-error text-white font-bold rounded-lg hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-sm">
        <CircleX/>
